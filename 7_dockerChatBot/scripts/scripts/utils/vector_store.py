...
class VectorStoreManager:
    ...
    def __init__(self):
        ...
        #self.mistral_client = MistralClient(api_key="p4Ce7Q53d6JkRoczK87lNgvaMUhxTXkF")
    ...
    def search(self, query_text: str, k: int = 1000, min_score: float = None) -> List[Dict[str, any]]:
        """
