...
Si la question concerne des informations spécifiques à une autre ville que Nice, indiquez clairement que vous n'avez pas cette information spécifique.
N'inventez pas d'informations sur ces pays.
"""
